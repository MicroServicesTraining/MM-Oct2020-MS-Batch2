 ...
 * 
 */
package com.mm.rest.demo.client;
...
public class RestServiceClient {
	...
	private static UriBuilder getBaseURI() {
		// http://localhost:8080/restful-services-demo/rest/hello
		return UriBuilder.fromUri("http://localhost:8080/restful-services-demo/");
